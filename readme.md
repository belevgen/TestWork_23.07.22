...
В соответствии с заданием, входной массив, либо задан, либо вводися с клавиатуры вручную пользователем.
Ручной ввод реализован методом ввода с клавиатуры Да или Нет:  
